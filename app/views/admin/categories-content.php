...
<section class="admin-panel" id="categoryForm">
    ...
    <form class="admin-form" method="POST" action="">
        ...
        <label>
            ...
            <input type="text" name="name" placeholder="Nama Kategori (Maks 100 char)" required>
        </label>
                ...
                <?php foreach ($categories as $cat): ?>
                    <tr>
                        ...
                        <td style="display:flex;gap:0.5rem;align-items:center;">
                            <form method="POST" style="display:inline;" onsubmit="return confirm('Hapus kategori ini? Buku yang terkait akan error jika tidak dipindah!');">
